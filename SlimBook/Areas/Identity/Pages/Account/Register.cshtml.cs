...
namespace SlimBook.Areas.Identity.Pages.Account
{
	[AllowAnonymous]
	public class RegisterModel : PageModel
	{
		...
		public async Task OnGetAsync(string returnUrl = null)
		{
			...
			Input = new InputModel()
			{
				...
				RoleList = _roleManager.Roles.Where(r => r.Name != SD.Role_User_Indi).Select(c => c.Name).Select(n => new SelectListItem
				{
					Text = n,
					Value = n
				})
			...
			{
				Input.RoleList = Input.RoleList.Where(r => r.Text == SD.Role_User_Comp);
			}
		...
		public async Task<IActionResult> OnPostAsync(string returnUrl = null)
		{
			...
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					// Role Assignment - Not created by an Admin
					if (user.Role == null)
					{
